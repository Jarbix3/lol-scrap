...
> `reports/Manuchito-LAS/` abierta en el explorer y dejá que el LLM
> lea los .md y escriba el análisis.

## Contexto

El directorio `reports/Manuchito-LAS/` contiene **6 archivos de
datos** generados por el scraper:

- `reports/Manuchito-LAS/GLOBAL.md` — overview cross-role (datos sin filtro de rol; incluye comparativa entre roles, sec. 12 sinergias humanas globales)
- `reports/Manuchito-LAS/MIDDLE.md` — datos filtrados al rol **Mid** (268 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/Manuchito-LAS/TOP.md` — datos filtrados al rol **Top** (245 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/Manuchito-LAS/JUNGLE.md` — datos filtrados al rol **Jungla** (126 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/Manuchito-LAS/BOTTOM.md` — datos filtrados al rol **ADC** (38 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/Manuchito-LAS/UTILITY.md` — datos filtrados al rol **Support** (28 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
...
(`reports/Manuchito-LAS/COACH_ANALYSIS.md`) con **7 secciones**:
...
2. **Sección 2 — Mid (MIDDLE)**: análisis específico del rol Mid basado en `MIDDLE.md` (268 partidas). Sigue el formato coach senior de Mid: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
3. **Sección 3 — Top (TOP)**: análisis específico del rol Top basado en `TOP.md` (245 partidas). Sigue el formato coach senior de Top: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
4. **Sección 4 — Jungla (JUNGLE)**: análisis específico del rol Jungla basado en `JUNGLE.md` (126 partidas). Sigue el formato coach senior de Jungla: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
5. **Sección 5 — ADC (BOTTOM)**: análisis específico del rol ADC basado en `BOTTOM.md` (38 partidas). Sigue el formato coach senior de ADC: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
6. **Sección 6 — Support (UTILITY)**: análisis específico del rol Support basado en `UTILITY.md` (28 partidas). Sigue el formato coach senior de Support: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
...
---
> ## Sección 2 — Mid (MIDDLE) — basado en `MIDDLE.md` (268 partidas)
>
...
---
> ## Sección 3 — Top (TOP) — basado en `TOP.md` (245 partidas)
>
...
---
> ## Sección 4 — Jungla (JUNGLE) — basado en `JUNGLE.md` (126 partidas)
>
...
---
> ## Sección 5 — ADC (BOTTOM) — basado en `BOTTOM.md` (38 partidas)
>
...
---
> ## Sección 6 — Support (UTILITY) — basado en `UTILITY.md` (28 partidas)
>
...
Cuando termines, **escribí el output a `reports/Manuchito-LAS/COACH_ANALYSIS.md`** (un solo archivo con las 7 secciones). El archivo final debería rondar las 5600-10500 palabras totales y tener tablas markdown para los scores 1-5, para las comparativas de métricas entre archivos, y para el ranking final + plan de acción de la sección 7.
