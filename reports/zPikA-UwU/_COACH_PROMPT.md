# COACH 360° — Análisis cross-role para zPikA#UwU

> **Generado automáticamente por `lol-scrap` el 2026-05-08 21:39 UTC.**
> Pegá este prompt completo en el chat de Cursor con la carpeta
> `reports/zPikA-UwU/` abierta en el explorer y dejá que el LLM
> lea los .md y escriba el análisis.

## Contexto

El directorio `reports/zPikA-UwU/` contiene **6 archivos de
datos** generados por el scraper:

- `reports/zPikA-UwU/GLOBAL.md` — overview cross-role (datos sin filtro de rol; incluye comparativa entre roles, sec. 12 sinergias humanas globales)
- `reports/zPikA-UwU/BOTTOM.md` — datos filtrados al rol **ADC** (149 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/zPikA-UwU/UTILITY.md` — datos filtrados al rol **Support** (105 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/zPikA-UwU/TOP.md` — datos filtrados al rol **Top** (35 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/zPikA-UwU/JUNGLE.md` — datos filtrados al rol **Jungla** (25 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/zPikA-UwU/MIDDLE.md` — datos filtrados al rol **Mid** (20 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
...
(`reports/zPikA-UwU/COACH_ANALYSIS.md`) con **7 secciones**:
...
2. **Sección 2 — ADC (BOTTOM)**: análisis específico del rol ADC basado en `BOTTOM.md` (149 partidas). Sigue el formato coach senior de ADC: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
3. **Sección 3 — Support (UTILITY)**: análisis específico del rol Support basado en `UTILITY.md` (105 partidas). Sigue el formato coach senior de Support: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
4. **Sección 4 — Top (TOP)**: análisis específico del rol Top basado en `TOP.md` (35 partidas). Sigue el formato coach senior de Top: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
5. **Sección 5 — Jungla (JUNGLE)**: análisis específico del rol Jungla basado en `JUNGLE.md` (25 partidas). Sigue el formato coach senior de Jungla: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
6. **Sección 6 — Mid (MIDDLE)**: análisis específico del rol Mid basado en `MIDDLE.md` (20 partidas). Sigue el formato coach senior de Mid: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
...
---
> ## Sección 2 — ADC (BOTTOM) — basado en `BOTTOM.md` (149 partidas)
>
...
---
> ## Sección 3 — Support (UTILITY) — basado en `UTILITY.md` (105 partidas)
>
...
---
> ## Sección 4 — Top (TOP) — basado en `TOP.md` (35 partidas)
>
...
---
> ## Sección 5 — Jungla (JUNGLE) — basado en `JUNGLE.md` (25 partidas)
>
...
---
> ## Sección 6 — Mid (MIDDLE) — basado en `MIDDLE.md` (20 partidas)
>
...
Cuando termines, **escribí el output a `reports/zPikA-UwU/COACH_ANALYSIS.md`** (un solo archivo con las 7 secciones). El archivo final debería rondar las 5600-10500 palabras totales y tener tablas markdown para los scores 1-5, para las comparativas de métricas entre archivos, y para el ranking final + plan de acción de la sección 7.
