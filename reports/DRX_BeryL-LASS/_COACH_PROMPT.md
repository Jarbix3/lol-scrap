# COACH 360° — Análisis cross-role para DRX BeryL#LASS
...
> `reports/DRX_BeryL-LASS/` abierta en el explorer y dejá que el LLM
> lea los .md y escriba el análisis.

## Contexto

El directorio `reports/DRX_BeryL-LASS/` contiene **6 archivos de
datos** generados por el scraper:

- `reports/DRX_BeryL-LASS/GLOBAL.md` — overview cross-role (datos sin filtro de rol; incluye comparativa entre roles, sec. 12 sinergias humanas globales)
- `reports/DRX_BeryL-LASS/MIDDLE.md` — datos filtrados al rol **Mid** (187 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/DRX_BeryL-LASS/JUNGLE.md` — datos filtrados al rol **Jungla** (95 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/DRX_BeryL-LASS/UTILITY.md` — datos filtrados al rol **Support** (40 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/DRX_BeryL-LASS/BOTTOM.md` — datos filtrados al rol **ADC** (34 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
- `reports/DRX_BeryL-LASS/TOP.md` — datos filtrados al rol **Top** (23 partidas) con stats avanzadas Riot challenges específicas (sec. 6) y análisis cruzado (sec. 6.1)
...
(`reports/DRX_BeryL-LASS/COACH_ANALYSIS.md`) con **7 secciones**:
...
2. **Sección 2 — Mid (MIDDLE)**: análisis específico del rol Mid basado en `MIDDLE.md` (187 partidas). Sigue el formato coach senior de Mid: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
3. **Sección 3 — Jungla (JUNGLE)**: análisis específico del rol Jungla basado en `JUNGLE.md` (95 partidas). Sigue el formato coach senior de Jungla: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
4. **Sección 4 — Support (UTILITY)**: análisis específico del rol Support basado en `UTILITY.md` (40 partidas). Sigue el formato coach senior de Support: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
5. **Sección 5 — ADC (BOTTOM)**: análisis específico del rol ADC basado en `BOTTOM.md` (34 partidas). Sigue el formato coach senior de ADC: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
6. **Sección 6 — Top (TOP)**: análisis específico del rol Top basado en `TOP.md` (23 partidas). Sigue el formato coach senior de Top: scores 1-5 por stat core, fortalezas/debilidades específicas, acciones semanales, fases del juego, matchups, pool ideal y conclusión sintetizada.
...
---
> ## Sección 2 — Mid (MIDDLE) — basado en `MIDDLE.md` (187 partidas)
>
...
---
> ## Sección 3 — Jungla (JUNGLE) — basado en `JUNGLE.md` (95 partidas)
>
...
---
> ## Sección 4 — Support (UTILITY) — basado en `UTILITY.md` (40 partidas)
>
...
---
> ## Sección 5 — ADC (BOTTOM) — basado en `BOTTOM.md` (34 partidas)
>
...
---
> ## Sección 6 — Top (TOP) — basado en `TOP.md` (23 partidas)
>
...
Cuando termines, **escribí el output a `reports/DRX_BeryL-LASS/COACH_ANALYSIS.md`** (un solo archivo con las 7 secciones). El archivo final debería rondar las 5600-10500 palabras totales y tener tablas markdown para los scores 1-5, para las comparativas de métricas entre archivos, y para el ranking final + plan de acción de la sección 7.
